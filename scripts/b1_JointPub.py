...
# Declare the output Messages
def init_joints():
    contJoints.header.frame_id = _base_frame
    contJoints.header.stamp = rospy.Time.now()
    contJoints.name.extend([_right_wheel_joint , _left_wheel_joint ])
...
if __name__=='__main__':
    ...
    #Simulation Parameters
    _right_wheel_joint = rospy.get_param("~wheelR_joint", "rightWheel")
    _left_wheel_joint = rospy.get_param("~wheelL_joint", "leftWheel")
